                            ...
                            <tr>
                                ...
                                <td colspan="2" class="store-pickup-location-action-wrapper" style="display: flex;">
                                    <?php if ( ( 0 === $key && ! $is_address_verified ) || 0 !== $key ) : ?>
                                        <button class="dokan-btn dokan-btn-default dokan-btn-sm store-pickup-location-edit-btn" data-location="<?php echo htmlspecialchars( wp_json_encode( $location ) ); ?>" data-location-index="<?php echo esc_attr( $key ); ?>"><span class="dashicons dashicons-edit"></span></button>
                                    <?php endif; ?>
                                    <?php if ( 0 !== $key ) : ?>
                                        <button class="dokan-btn dokan-btn-default dokan-btn-sm store-pickup-location-delete-btn" data-location-index="<?php echo esc_attr( $key ); ?>"><span class="dashicons dashicons-trash"></span></button>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
